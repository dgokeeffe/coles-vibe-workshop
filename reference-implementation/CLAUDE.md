...
> **Scope:** You are inside `reference-implementation/`. This is the facilitator answer key — do not edit files outside this directory. Sibling codebases (`starter-kit/`, `quiz-app/`) exist but are out of scope for this session.
